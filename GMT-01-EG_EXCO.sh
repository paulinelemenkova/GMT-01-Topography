...
gmt grdcut GEBCO_2023.nc -R24/38/21/32 -Geg_relief.nc
# gdalinfo -stats eg1_relief.nc
gmt grdinfo -M eg_relief.nc
#  actual_range={-3200,2373}
...
# Make color palette
# gmt makecpt -Cglobe -V -T-3200/2553 > pauline.cpt
# gmt makecpt -Cgray -V -T-3200/2553 > pauline.cpt
# gmt makecpt -CSCM/grayC -V -T-3200/2553 > pauline.cpt
# gmt makecpt -Ccpt-city/elevation -V -T-3200/2553 > pauline.cpt
# gmt makecpt -Ccpt-city/dem1 -V -T-3200/2553 > pauline.cpt
gmt makecpt -Cgmt/globe -V -T-3200/2553 > pauline.cpt
...
gmt pscoast -R -J -Ia/thinner,blue -Na -SSTEELBLUE2 -W2/thin,blue,0.1p -Df -O -K >> $ps
...
gmt psscale -Dg24/20+w16.0c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg500f100a500+l"Colormap: 'Globe' Colors for global bathymetry/topography relief [R=-3200/2553, C=RGB]" \
    -I0.2 -By+lm -O -K >> $ps
...
gmt psxy -R -J -Sj-13/2.5/2.5 -W2.0p,red -O -K << EOF >> $ps
30.4 30.3
EOF
...
read x0 y0 w h < tmp
gmt pscoast --MAP_GRID_PEN_PRIMARY=thin,grey --MAP_FRAME_PEN=thin,white -Rg -JG28.0/25.0N/$w -Da -Glightgoldenrod1 -A5000 -Bga -Wfaint -EEG+gred -SSTEELBLUE3 -O -K -X$x0 -Y$y0 >> $ps
