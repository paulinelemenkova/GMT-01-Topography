...
gmt makecpt -Cgmt/etopo1 -V -T-10898/6560 > poocean.cpt

# Generate a file
ps=BathymetryPO.ps
# Make raster image
#gmt grdimage po_relief.nc -Cpoocean.cpt -R -JY180/0/6.5i -I+a15+ne0.75 -Xc -K > $ps
gmt grdimage po_relief.nc -Cpoocean.cpt -R110/295/-70/70 -JA200/0/6.5i -I+a15+ne0.75 -Xc -K > $ps
...
gmt psbasemap -R -J \
    ...
    -Lx14c/-1.2c+c50+w3000k+l"Lambert Azimuthal Equal-Area projection. Scale (km)"+f \
...
gmt psconvert BathymetryPO.ps -A1.5c -E720 -Tj -Z
