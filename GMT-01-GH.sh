...
# Make color palette
gmt makecpt -Cgeo.cpt -V -T-4696/915 > pauline.cpt
...
read x0 y0 w h < tmp
gmt pscoast --MAP_GRID_PEN_PRIMARY=thin,grey -Rg -JG-1.0/8.0N/$w -Da -Glightgoldenrod1 -A5000 -Bga -Wfaint -EGH+gred -Sdodgerblue -O -K -X$x0 -Y$y0 >> $ps
