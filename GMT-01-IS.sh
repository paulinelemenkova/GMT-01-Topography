...
# 13W25W
#gmt grdcut ETOPO1_Ice_g_gmt4.grd -R335/347/63/67 -Gice_relief.nc
gmt grdcut GEBCO_2019.nc -R335/347/63/67 -Gice_relief.nc
gdalinfo -stats ice_relief.nc
# Minimum=-1871.073, Maximum=2007.597

ps=Topo_Ice.ps
# Make color palette
gmt makecpt -Ctopo.cpt -V -T-1872/2008 > myocean.cpt
...
#gmt makecpt -Cturbo.cpt -V -T-1870/2649 > myocean.cpt

# Make raster image
gmt grdimage ice_relief.nc -Cmyocean.cpt -R335/347/63/67 -JM6i -P -I+a15+ne0.75 -Xc -K > $ps

# Add legend
gmt psscale -Dg333.6/63+w12.0c/0.15i+v+o0.3/0i+ml+e -Np -R -J -Cmyocean.cpt \
	--FONT_LABEL=6p,Helvetica,dimgray \
    --FONT_ANNOT_PRIMARY=6p,Helvetica,dimgray \
    --FONT_TITLE=6p,Helvetica,black \
	-Bg500f50a500+l"Color scale: 'topo' Sandwell/Anderson colors for topography [R=-1872/2008, H, C=HSV]" \
	-I0.2 -By+lm -O -K >> $ps
...
gmt pscoast -R -J -P \
    -Ia/thinner,blue -Na -N1/thickest,red -Wthinner,brown -Df -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    --FONT_ANNOT_PRIMARY=8p,0,dimgray \
    -Bpxg1f0.5a1 -Bpyg1f0.5a0.5 -Bsxg2 -Bsyg1 \
    -B+t"Topographic map of Iceland with study area (red square)" -O -K >> $ps
...
# Study area
gmt psbasemap -R -J \
    -D337/63.6/341/65.2r -F+pthick,red+r \
    -O -K >> $ps
# City
...
read x0 y0 w h < tmp
gmt pscoast --MAP_GRID_PEN_PRIMARY=thin,grey -Rg -JG-20/65N/$w -Da -Gmistyrose1 -A5000 -Bga -Wfaint -EIS+gred -Sroyalblue1 -O -K -X$x0 -Y$y0 >> $ps
#gmt pscoast -Rg -JG12/5N/$w -Da -Gbrown -A5000 -Bg -Wfaint -ECM+gbisque -O -K -X$x0 -Y$y0 >> $ps
gmt psxy -R -J -O -K -T  -X-${x0} -Y-${y0} >> $ps

# Add GMT logo
gmt logo -Dx6.2/-2.1+o0.1i/0.1i+w2c -O -K >> $ps
# Add subtitle
...
gmt psconvert Topo_Ice.ps -A0.2c -E720 -Tj -Z
