...
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f10p,25,black+jLB+a-45 -Gwhite@50>> $ps << EOF
300.0 -22.0 PARAGUAY
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f9p,25,black+jLB -Gwhite@50 >> $ps << EOF
302.0 -33.0 URUGUAY
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f10p,25,black+jLB -Gwhite@50 >> $ps << EOF
...
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f9p,25,black+jLB+a-75 -Gwhite@50 >> $ps << EOF
300.5 5.6 GUYANA
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f7p,25,black+jLB+a-75 -Gwhite@50 >> $ps << EOF
303 5.8 SURINAME
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f8p,25,black+jLB -Gwhite@50 >> $ps << EOF
306 5.0 FRENCH
306 4.0 GUIANA
EOF
