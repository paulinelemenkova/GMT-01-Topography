#!/bin/sh
# Purpose: shaded relief grid raster map from the GEBCO dataset (here: Costa Rica)
...
gmt makecpt -Cgeo.cpt -V -T-4944/3696 > pauline.cpt
...
gmt psbasemap -R -J \
    ...
    -B+t"Topographic map of Costa Rica" -O -K >> $ps
...
gmt psconvert Topography_CR.ps -A0.5c -E720 -Tj -Z
