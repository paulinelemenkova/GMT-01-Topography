...
# Make color palette
# makecpt --help
gmt makecpt -Cgeo.cpt -V -T-100/6560 > pauline.cpt
...
read x0 y0 w h < tmp
gmt pscoast --MAP_GRID_PEN_PRIMARY=thin,grey -Rg -JG300/16S/$w -Da -Gbrown -A5000 -Bg -Wfaint -ESA+gpeachpuff -EBO+gyellow -Slightskyblue1 -O -K -X$x0 -Y$y0 >> $ps
