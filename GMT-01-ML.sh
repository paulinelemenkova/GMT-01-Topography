...
gmt grdcut ETOPO1_Ice_g_gmt4.grd -R-6/3/9/15.5 -Gml1_relief.nc
gmt grdcut GEBCO_2019.nc -R-6/3/9/15.5 -Gml_relief.nc
...
gmt pscoast -R-6/3/9/15.5 -JM5.5i -Dh -M -EML > Mali.txt
#####################################################################

ps=Topo_BF.ps
# Make background transparent image
gmt grdimage ml_relief.nc -Cpauline.cpt -R-6/3/9/15.5 -JM5.5i -I+a15+ne0.75 -t40 -Xc -P -K > $ps
...
# Add raster image
gmt grdimage ml_relief.nc -Cpauline.cpt -R-6/3/9/15.5 -JM5.5i -I+a15+ne0.75 -Xc -P -O -K >> $ps
# Add isolines
