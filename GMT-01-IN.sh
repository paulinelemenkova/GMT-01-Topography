...
gmt makecpt -Cturbo -V -T-5398/8271 > pauline.cpt
...
gmt grdimage in1_relief.nc -Cpauline.cpt -R65/100/5/36 -JM6.5i -I+a15+ne0.75 -t70 -Xc -P -K > $ps
...
gmt psscale -Dg65/3+w16.0c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
