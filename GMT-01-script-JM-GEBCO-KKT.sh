...
gmt makecpt -Cgebco.cpt -V -T-10000/1000 > myocean.cpt
# Step-6. Make raster image
gmt grdimage GEBCO_2019.nc -Cmyocean.cpt -R140/170/40/60 -JM6i -P -I+a15+ne0.75 -Xc -K > $ps
...
gmt psconvert BathymetryKKT_GEBCO.ps -A0.2c -E720 -Tj -Z
