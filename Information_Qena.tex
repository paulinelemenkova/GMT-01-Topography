...
\centering
	...
	\caption{Topographic map of Egypt. Software: Generic Mapping Tools (GMT) version 6.1.1, \cite{Wessel}. Data source: GEBCO/SRTM \cite{GEBCO,SRTM}. Cartography source: authors.
	\label{fig01}}
\end{figure}
