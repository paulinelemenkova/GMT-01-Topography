...
gmt makecpt -CgrayC -V -T-3000/500 > pauline.cpt
...
gmt psscale -Dg7.8/-30+w15.3c/0.15i+v+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg1000f100a1000+l"Colormap: 'turbo' - an Improved Rainbow Colormap for Visualization [R=-4430/2533, H, C=RGB]" \
    -I0.2 -By+l"m" -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Land cover map of Namibia" -O -K >> $ps
...
gmt pstext -R -J -N -O -K \
-F+f14p,0,ivory+jLB >> $ps << EOF
20.50 -28.6 S O U T H   A F R I C A
EOF
gmt pstext -R -J -N -O -K \
