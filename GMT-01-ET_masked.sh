...
# Add isolines
gmt grdcontour et_relief.nc -R -J -C500 -A1000 -Wthinner,darkbrown -O -K >> $ps
...
gmt psscale -Dg31.5/3+w13.3c/0.15i+v+o0.0/0i+ml -R -J -Cmyocean.cpt \
    ...
    -Bg500f50a500+l"Color scale: 'turbo' colors for bathymetry/topography [R=-3481/4326, H=0, C=HSV]" \
    -I0.2 -By+lm -O -K >> $ps
...
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f10p,0,royalblue4+jLB+a-30 >> $ps << EOF
48.3 29.1 Bab al Mandab
EOF
# COUNTRIES
gmt pstext -R -J -N -O -K \
