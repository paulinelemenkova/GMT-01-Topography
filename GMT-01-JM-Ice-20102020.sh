...
ps=BathymetryIce.ps
# Make color palette
gmt makecpt -Cglobe.cpt -V -T-1870/2649 > myocean.cpt
...
gmt psscale -Dg333.1/63+w12.0c/0.15i+v+o0.3/0i+ml -R -J -Cmyocean.cpt \
	...
	-Bg500f100a500+l"Color scale: globe [Colors for global bathymetry/topography relief R=-1870/2649, H=0, C=RGB]" \
	-I0.2 -By+lm -O -K >> $ps
...
# Study area
gmt psbasemap -R -J \
    -D339/65.0/343/66.6r -F+pthick,red \
    -O -K >> $ps
# City
