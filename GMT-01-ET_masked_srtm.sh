...
# Make color palette
gmt makecpt -Csrtm.cpt -V -T-3481/4326 > myocean.cpt
# etopo1 world elevation dem1 dem2 dem3
...
gmt psscale -Dg31.5/3+w13.3c/0.15i+v+o0.0/0i+ml -R -J -Cmyocean.cpt \
    ...
    -Bg500f50a500+l"Colormap: 'srtm' DEM scale by Dewez/Wessel [R=-3481/4326, H=0, C=RGB]" \
    -I0.2 -By+lm -O -K >> $ps
...
gmt pstext -R -J -N -O -K \
-F+jTL+f10p,26,white+jLB+a-305 -Gsaddlebrown@60 >> $ps << EOF
37.9 6.5 Great Rift
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f10p,26,white+jLB+a-320 -Gsaddlebrown@60 >> $ps << EOF
39.0 8.0 Valley
EOF
gmt pstext -R -J -N -O -K \
...
4.0 9.0 Digital elevation data: SRTM/GEBCO, 15 arc sec resolution grid
EOF

# Convert to image file using GhostScript
gmt psconvert Topo_ET_srtm.ps -A0.5c -E720 -Tj -Z
